...
ReactDOM.render(<SimpleSortable sinkUndraggables={true} />, document.getElementById('Example'));
ReactDOM.render(<SimpleSortable floatUndraggables={true} />, document.getElementById('HorizontalExample'));
